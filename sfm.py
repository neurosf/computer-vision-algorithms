...
class SFM:
    ...
    def compute_pose(self, view1, view2=None, is_baseline=False):
        ...
        # procedure for estimating the pose of all other views
            ...
            # Only reconstruct unreconstructed points from the most recent previous view
            ...
            self.remove_mapped_points(match_object, self.get_index_of_view(old_view))
    ...
    def triangulate(self, view1, view2):
        ...
        if len(pixel_points1) > 0 and len(pixel_points2) > 0:
    ...
    def reconstruct(self):
        ...
        # Save the final set of 3D points to a PLY file
        self.plot_points()
        logging.info("Final points plotted for %d views", len(self.done))

    def visualize_points(self):
        """Visualizes the 3D points stored in self.points_3D"""
        if self.points_3D.shape[0] == 0:
