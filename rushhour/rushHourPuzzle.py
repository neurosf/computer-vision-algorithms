    ...
    def successorFunction(self):
        ...
        for index, vehicle in enumerate(self.vehicles):
            ...
            if vehicle["orientation"] == 'H':
                ...
                if x_position + vehicle["length"] < self.board_width and \
                    self.board[y_position][x_position+vehicle["length"]] == ' ':
                    successor = deepcopy(self)
                    successor.vehicles = deepcopy(self.vehicles)
                    # update the vehicle's position
                    successor.vehicles[index]["x"] = x_position+1
            ...
            # check if vehicle is oriented vertically
                ...
                if y_position + vehicle["length"] < self.board_height and \
                    self.board[y_position+vehicle["length"]][x_position] == ' ':
                    successor = deepcopy(self)
                    successor.vehicles = deepcopy(self.vehicles)
                    # update the vehicle's position
                    successor.vehicles[index]["y"] = y_position+1
